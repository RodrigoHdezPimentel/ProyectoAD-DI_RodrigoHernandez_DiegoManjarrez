...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String[] IP_RODRIGO = {"192.168.128.250", "192.168.0.251", "192.168.243.6"};//clase-casa-movil
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retrofitTemas = new Retrofit.Builder()
                .baseUrl("http://" + IP_RODRIGO[2] +":8086/tema/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        retrofitUser = new Retrofit.Builder()
                .baseUrl("http://" + IP_RODRIGO[2] +":8086/usuario/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        retrofitUserTema =  new Retrofit.Builder()
                .baseUrl("http://" + IP_RODRIGO[2] +":8086/usuarioTema/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        retrofitLike = new Retrofit.Builder()
                .baseUrl("http://" + IP_RODRIGO[2] +":8086/like/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        retrofitConversacion = new Retrofit.Builder()
                .baseUrl("http://" + IP_RODRIGO[2] +":8086/conversacion/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        retrofitGrupo = new Retrofit.Builder()
                .baseUrl("http://" + IP_RODRIGO[2] +":8086/grupo/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
